...
describe 'Log utility' do
  ...
  describe 'validate_file' do
    it 'returns an array containing the bool and message from the uploaded file validator' do
      ...
      file_big = Rack::Test::UploadedFile.new(Rails.root.join('spec/fixtures/auth-test-size.log'),
                                              'application/octet-stream')
      file_empty = Rack::Test::UploadedFile.new(Rails.root.join('spec/fixtures/auth-test-empty.log'),
                                                'application/octet-stream')
