...
describe "Preprocess log" do
  ...
  describe "get_date_range" do
    ...
    it "returns first and last date from log" do
      ...
      expected = { "2025-03-27" => 0, "2025-03-28" => 0, "2025-03-29" => 0, "2025-03-30" => 0, "2025-03-31" => 0, "2025-04-01" => 0,
                   "2025-04-02" => 0, "2025-04-03" => 0, "2025-04-04" => 0, "2025-04-05" => 0, "2025-04-06" => 0, "2025-04-07" => 0, "2025-04-08" => 0, "2025-04-09" => 0, "2025-04-10" => 0, "2025-04-11" => 0, "2025-04-12" => 0, "2025-04-13" => 0, "2025-04-14" => 0, "2025-04-15" => 0, "2025-04-16" => 0, "2025-04-17" => 0, "2025-04-18" => 0, "2025-04-19" => 0, "2025-04-20" => 0 }
      expect(result).to eq(expected)
    end
  end
end
