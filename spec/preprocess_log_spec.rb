...
describe "Preprocess log" do
  ...
  describe "parse authentication failure" do
    it "returns hash meta data for authenitcation failure" do
      result = parse_auth_failure(auth_fail, 87)
      expected = 
      {
        Line_number: 87,
        Date: "Mar 27",
  ...
  describe "parse disconnected event" do
    it "returns hash meta data for a disonnected event" do
      result = parse_disconnect(disconnect, 89)
      expected = 
      {
        Line_number: 89, 
        Date: "Mar 27", 
  ...
  describe "parse session opened event" do
    it "returns hash meta data for session open event" do
      result = parse_session_open(open, 11)
      expected = 
      {
        Line_number: 11, 
        Date: "Mar 27", 
        Time: "13:09:37", 
        Host: "ip-10-77-20-248", 
        Message: "sudo: pam_unix(sudo:session): session opened",
        User: "root",  
      }
      expect(result).to eq(expected)
    end
  ...
  describe "parse session closed event" do
    it "returns hash meta data for session closed event" do
      result = parse_session_close(close, 12)
      expected = 
      {
        Line_number: 12, 
        Date: "Mar 27", 
        Time: "13:09:38", 
        Host: "ip-10-77-20-248", 
        Message: "sudo: pam_unix(sudo:session): session closed",
        User: "root",  
      }
      expect(result).to eq(expected)
    end
  ...
  describe "parse sudo command event" do
    it "returns hash meta data for sudo command event" do
      result = parse_sudo_command(sudo, 37)
      expected = 
      {
        Line_number: 37, 
        Date: "Mar 27", 
  ...
  describe "parse accepted event" do
    it "returns hash meta data for accept event" do
      result = parse_accept_event(accepted, 841)
      expected = 
      {
        Line_number: 841, 
        Date: "Mar 28", 
  ...
  describe "parse invalid user event" do
    it "returns hash meta data for invalid user event" do
      result = parse_invalid_user(invalid_user, 3741)
      expected = 
      {
        Line_number: 3741, 
        Date: "Mar 31", 
  ...
  describe "parse failed password event" do
    it "returns hash meta data for failed password event" do
      result = parse_failed_password(failed_password, 3745)
      expected = 
      {
        Line_number: 3745, 
        Date: "Mar 31", 
